...
import { Octicons, Entypo, SimpleLineIcons, MaterialCommunityIcons, EvilIcons, AntDesign } from '@expo/vector-icons';
...
export default function Post({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#fff', }}>
            <View style={{ alignItems: 'flex-start', gap: 16, width: 348, left: 14, marginTop: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'grey', opacity: 0.9, paddingBottom: 5 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <MaterialCommunityIcons name="pin-outline" size={24} color="#BDBDBD" />
                    <Text style={{ color: '#BDBDBD', fontWeight: 600, fontSize: 14, textAlign: 'center', }}>Pinned post</Text>
                </View>
            </View>
            <FlatList
                data={dataUser}
                renderItem={({ item }) => (
                    <View style={{ marginVertical: 10, position: 'relative', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'grey', height: 340, left: 16, width: '100%' }}>
